...
function demo_system_cont()
    ...
    sol = Integration.integrate_ode(compiled_system.f, x0, tspan, params=p)
    ...
    ContinuationNewton.continuate_newton(f, eq, Jac=nothing, h=0.01)
